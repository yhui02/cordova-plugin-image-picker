...
- (void) getPictures:(CDVInvokedUrlCommand *)command {
    ...
    NSInteger maximumImagesCount = [options[@"maximumImagesCount"] integerValue];
    [self launchGMImagePicker:allow_video title:title maximumImagesCount:maximumImagesCount message:message disable_popover:disable_popover];
}

- (void)launchGMImagePicker:(bool)allow_video title:(NSString *)title maximumImagesCount:(NSInteger *)maximumImagesCount message:(NSString *)message disable_popover:(BOOL)disable_popover
{
